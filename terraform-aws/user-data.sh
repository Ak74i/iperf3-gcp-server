#!/bin/bash
# iPerf3 Server Configuration Script for AWS EC2
...
echo "==================== iPerf3 Server Setup Started ===================="
...
# iPerf3 Network Performance Optimizations
# TCP Buffer Sizes
...
if [ -n "$primary_interface" ]; then
    ...
    ethtool_info=$(ethtool $primary_interface 2>/dev/null | grep "Speed:")
...
#!/bin/bash
# iPerf3 Performance Test Script
...
while true; do
    ...
    health_status="{\"status\":\"healthy\",\"timestamp\":\"$(date -Iseconds)\",\"services\":["
...
# Log final status
echo "==================== iPerf3 Server Setup Completed ===================="
...
🎉 iPerf3 High-Speed Test Server Setup Complete!
